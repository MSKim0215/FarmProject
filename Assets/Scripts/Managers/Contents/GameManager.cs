...
public class GameManager
{
    ...
    public GameObject Spawn(Define.WorldObject _type, string _path, Vector3 _dir, Quaternion _eulr, Transform _parent = null)
    {
        GameObject prefab = Managers.Resource.Instantiate(_path, _dir, _eulr, _parent);
        switch (_type)
        {
            case Define.WorldObject.Monster:
                {
